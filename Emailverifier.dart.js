...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var validator, t2, t3,
        t1 = document,
        input = t1.querySelector("input"),
        div = t1.querySelector("div");
      t1 = type$.String;
      validator = A._StreamHandlerTransformer$(new A.main_closure(), t1, t1);
      div.toString;
      J.set$innerHtml$x(div, "Enter a valid");
      input.toString;
      t1 = J.get$onInput$x(input);
      t2 = t1.$ti;
      t3 = t2._eval$1("String(Stream.T)")._as(new A.main_closure0());
      t2 = t2._eval$1("_MapStream<Stream.T,String>");
      t2._eval$1("StreamTransformer<Stream.T,String>")._as(validator);
      validator.super$_StreamSinkTransformer$bind(validator.$ti._eval$1("Stream<1>")._as(new A._MapStream(t3, t1, t2))).listen$2$onError(new A.main_closure1(div), new A.main_closure2(div));
    },
  ...
  A._BoundSinkStream.prototype = {
    listen$4$cancelOnError$onDone$onError(onData, cancelOnError, onDone, onError) {
      ...
      subscription = new A._SinkTransformerStreamSubscription(onData, t4, type$.void_Function._as(t5), t2, t3 | 32, t1._eval$1("_SinkTransformerStreamSubscription<1,2>"));
  ...
  A.Element.prototype = {
    ...
    get$onInput(receiver) {
      return new A._ElementEventStreamImpl(receiver, "input", false, type$._ElementEventStreamImpl_Event);
    },
    $isElement: 1
  };
  ...
  A.main_closure.prototype = {
    call$2(inputValue, sink) {
      ...
      if (A.stringContainsUnchecked(inputValue, "@", 0)) {
        t1 = sink._sink;
  ...
  A.main_closure0.prototype = {
    call$1($event) {
      var t1 = type$.InputElement._as(J.get$target$x(type$.Event._as($event))).value;
      return t1 == null ? "" : t1;
    },
    $signature: 22
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._Future__chainForeignFuture_closure0, A._Future__propagateToListeners_handleWhenCompleteCallback_closure0, A.MapBase_mapToString_closure, A._ValidatingTreeSanitizer_sanitizeTree_walk, A.main_closure]);
...
//# sourceMappingURL=Emailverifier.dart.js.map
