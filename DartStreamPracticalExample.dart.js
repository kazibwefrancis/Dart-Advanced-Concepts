...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (button != null)
        J.get$onClick$x(button).timeout$2$onTimeout(new A.Duration(1000000), new A.main_closure()).listen$2$onError(new A.main_closure0(), new A.main_closure1());
    },
  ...
  A._BroadcastStreamController.prototype = {
    ...
    get$stream(_) {
      return new A._BroadcastStream(this, this.$ti._eval$1("_BroadcastStream<1>"));
    },
    get$_mayAddEvent() {
    ...
    addError$2(error, stackTrace) {
      ...
      _this._sendError$2(_0_0.error, _0_0.stackTrace);
    },
    addError$1(error) {
  ...
  A.Stream.prototype = {
    ...
    timeout$2$onTimeout(timeLimit, onTimeout) {
      ...
      t2._eval$1("~(EventSink<1>)?")._as(onTimeout);
      t1.controller = null;
      t3 = _this.get$isBroadcast() ? t1.controller = new A._SyncBroadcastStreamController(_null, _null, t2._eval$1("_SyncBroadcastStreamController<1>")) : t1.controller = new A._SyncStreamController(_null, _null, _null, _null, t2._eval$1("_SyncStreamController<1>"));
      zone = $.Zone__current;
      t1.timeoutCallback = null;
      t1.timeoutCallback = new A.Stream_timeout_closure(t1, _this, new A._ControllerEventSinkWrapper(_null, t2._eval$1("_ControllerEventSinkWrapper<1>")), zone, type$.$env_1_1_void._bind$1(t2._eval$1("EventSink<1>"))._eval$1("1(2)")._as(onTimeout));
      t3.set$onListen(new A.Stream_timeout_closure0(t1, _this, zone, timeLimit));
      t1 = t1.controller;
  ...
  A.Stream_timeout_closure.prototype = {
    call$0() {
      var _this = this,
        t1 = _this.wrapper;
      t1._sink = _this._box_1.controller;
      _this.zone.runUnaryGuarded$1$2(_this.registeredOnTimeout, t1, A._instanceType(_this.$this)._eval$1("_ControllerEventSinkWrapper<1>"));
      t1._sink = null;
    },
    $signature: 0
  };
  A.Stream_timeout_closure0.prototype = {
    call$0() {
      var t4, subscription, t5, _this = this, t1 = {},
        t2 = _this.timeLimit,
        t3 = _this._box_1;
      t1.timer = A.Timer__createTimer(t2, type$.void_Function._as(t3.timeoutCallback));
      t4 = _this.$this;
      subscription = t4.listen$1(null);
      t5 = _this.zone;
      subscription.onData$1(new A.Stream_timeout__closure(t1, t3, t4, t5, t2));
      subscription.onError$1(0, new A.Stream_timeout__closure0(t1, t3, t5, t2));
      subscription.onDone$1(new A.Stream_timeout__closure1(t1, t3));
      t3.controller.set$onCancel(new A.Stream_timeout__closure2(t1, subscription));
      if (!t4.get$isBroadcast()) {
        t4 = t3.controller;
        t4.set$onPause(0, new A.Stream_timeout__closure3(t1, subscription));
        t4.set$onResume(new A.Stream_timeout__closure4(t1, t3, subscription, t5, t2));
      }
    },
    $signature: 0
  };
  A.Stream_timeout__closure.prototype = {
    call$1($event) {
      var t1, t2, _this = this;
      A._instanceType(_this.$this)._precomputed1._as($event);
      t1 = _this._box_0;
      t1.timer.cancel$0();
      t2 = _this._box_1;
      t1.timer = A.Timer__createTimer(_this.timeLimit, type$.void_Function._as(t2.timeoutCallback));
  ...
  A.Stream_timeout__closure0.prototype = {
    call$2(error, stackTrace) {
      var t1, t2;
      type$.Object._as(error);
      type$.StackTrace._as(stackTrace);
      ...
      t1.timer.cancel$0();
      t2 = this._box_1;
      t1.timer = A.Timer__createTimer(this.timeLimit, type$.void_Function._as(t2.timeoutCallback));
      t2.controller._addError$2(error, stackTrace);
    },
    $signature: 2
  };
  A.Stream_timeout__closure1.prototype = {
    call$0() {
  ...
  A.Stream_timeout__closure2.prototype = {
    call$0() {
      this._box_0.timer.cancel$0();
  ...
  A.Stream_timeout__closure3.prototype = {
    call$0() {
      this._box_0.timer.cancel$0();
      this.subscription.pause$0(0);
    },
    $signature: 0
  };
  A.Stream_timeout__closure4.prototype = {
    call$0() {
      var _this = this;
      _this.subscription.resume$0();
      _this._box_0.timer = A.Timer__createTimer(_this.timeLimit, type$.void_Function._as(_this._box_1.timeoutCallback));
    },
    $signature: 0
  };
  A._ControllerEventSinkWrapper.prototype = {
    addError$2(error, stackTrace) {
      var sink = this._sink;
      if (sink == null)
        A.throwExpression(A.StateError$("Sink not available"));
  ...
  A._StreamController.prototype = {
    get$stream(_) {
      return new A._ControllerStream(this, this.$ti._eval$1("_ControllerStream<1>"));
    },
    get$_pendingEvents() {
      var t1, _this = this;
      if ((_this._state & 8) === 0)
    ...
    add$1(_, value) {
      ...
      if ((t2 & 1) !== 0) {
        t1._precomputed1._as(value);
        _this.get$_subscription()._add$1(value);
      } else if ((t2 & 3) === 0)
  ...
  A._DoneStreamSubscription.prototype = {
    ...
    onDone$1(handleDone) {
      ...
      if (this._state >= 0) {
        type$.void_Function._as(handleDone);
        this.set$_onDone(handleDone);
      }
    },
    pause$0(_) {
      var t1 = this._state;
  ...
  A.main_closure.prototype = {
    call$1(sink) {
      return type$.EventSink_MouseEvent._as(sink).addError$1("you lost nigga");
    },
    $signature: 13
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A.Stream, A._BufferingStreamSubscription, A._BroadcastStreamController, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._ControllerEventSinkWrapper, A._StreamController, A._SyncStreamControllerDispatch, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._DoneStreamSubscription, A._Zone, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._SyncBroadcastStreamController__sendData_closure, A._SyncBroadcastStreamController__sendError_closure, A._SyncBroadcastStreamController__sendDone_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A.Stream_timeout__closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A._EventStreamSubscription_onData_closure, A.main_closure, A.main_closure0, A.main_closure1]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__chainCoreFuture_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A.Stream_timeout_closure, A.Stream_timeout_closure0, A.Stream_timeout__closure1, A.Stream_timeout__closure2, A.Stream_timeout__closure3, A.Stream_timeout__closure4, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._BufferingStreamSubscription__sendError_sendError, A._BufferingStreamSubscription__sendDone_sendDone, A._PendingEvents_schedule_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure]);
    _inherit(A.NullError, A.TypeError);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._Future__chainForeignFuture_closure0, A._Future__propagateToListeners_handleWhenCompleteCallback_closure0, A.Stream_timeout__closure0]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null(@)", "Null(Object,StackTrace)", "~(~())", "Future<~>()", "Null()", "~(Object,StackTrace)", "~(Event)", "~(@)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "~(EventSink<MouseEvent>)", "~(MouseEvent)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","MathMLElement":"Element","HtmlDocument":"Node","Document":"Node","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_ControllerEventSinkWrapper":{"EventSink":["1"]},"_BufferingStreamSubscription":{"StreamSubscription":["1"],"_EventDispatch":["1"]},"AsyncError":{"Error":[]},"_BroadcastStream":{"_ControllerStream":["1"],"_StreamImpl":["1"],"Stream":["1"]},"_BroadcastSubscription":{"_ControllerSubscription":["1"],"_BufferingStreamSubscription":["1"],"StreamSubscription":["1"],"_EventDispatch":["1"]},"_BroadcastStreamController":{"EventSink":["1"],"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_SyncBroadcastStreamController":{"_BroadcastStreamController":["1"],"EventSink":["1"],"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_Future":{"Future":["1"]},"_StreamController":{"EventSink":["1"],"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_SyncStreamController":{"_SyncStreamControllerDispatch":["1"],"_StreamController":["1"],"EventSink":["1"],"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_ControllerStream":{"_StreamImpl":["1"],"Stream":["1"]},"_ControllerSubscription":{"_BufferingStreamSubscription":["1"],"StreamSubscription":["1"],"_EventDispatch":["1"]},"_StreamImpl":{"Stream":["1"]},"_DelayedData":{"_DelayedEvent":["1"]},"_DelayedError":{"_DelayedEvent":["@"]},"_DelayedDone":{"_DelayedEvent":["@"]},"_DoneStreamSubscription":{"StreamSubscription":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"MouseEvent":{"Event":[]},"HtmlElement":{"Element":[],"EventTarget":[]},"AnchorElement":{"Element":[],"EventTarget":[]},"AreaElement":{"Element":[],"EventTarget":[]},"Element":{"EventTarget":[]},"FormElement":{"Element":[],"EventTarget":[]},"Node":{"EventTarget":[]},"SelectElement":{"Element":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]},"SvgElement":{"Element":[],"EventTarget":[]}}'));
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      EventSink_MouseEvent: findType("EventSink<MouseEvent>"),
...
//# sourceMappingURL=DartStreamPracticalExample.dart.js.map
